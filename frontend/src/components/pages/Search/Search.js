			...
			<div className="search-results-container">
				{searchResults.map((result) => (
					<div className="search-result-item">
						...
						<div className="flex-row search-result-item-bottom">
							<div className="search-result-item-condition">{result.condition === "new" ? "Новая" : "Б/у"}</div>
							<button className="search-result-item-details-button">Подробнее</button>
						</div>
					</div>
				))}
			</div>
